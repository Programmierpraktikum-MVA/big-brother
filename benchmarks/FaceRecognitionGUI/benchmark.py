...
#Facerecog Libraries
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'src', 'face_recognition'))
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'src', 'face_recognition', 'haar_and_lbph'))
