    ...
    def __init__(self, mongo_client=None):
        ...
        if not mongo_client:
            self.cluster = pymongo.MongoClient(
                "mongodb+srv://admin:7EgqBof7tSUKlYBN@bigbrother.qse5xtp.mongodb.net/?retryWrites=true&w=majority",
...
class wire_DB(BBDB):
    ...
    def getTrainingPictures(self, user_uuid: uuid.UUID = None):
        ...
        resources = None
        #for i in self.wire_context_collection:
        #    print(i)
        #print(self.wire_context_collection)
        if user_uuid:
