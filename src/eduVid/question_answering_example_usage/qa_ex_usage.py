...
class QAAlgo:
    ...
    def answer_question(self, context, question):
        ...
        # create ready chunks
        ready_chunks = combine_sentences(
            self, chunks, tok_val_list, self.max_tokens_per_chunk
        )
...
# perform s2t
recog = SpeechRecog("audiocut.mp3") # set the audio file which will be transcribed
# define context
